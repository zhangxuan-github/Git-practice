 classdef hNRAppDelayVisualizer < handle
...
%         EnablePlots = false;
   ...
   properties(Access = private, Hidden)
    ...
    methods (Access = public)
        function obj = hNRAppDelayVisualizer(param, varargin)
...
%             end
            ...
            if isempty(obj.DelayVisualization)
                obj.DelayVisualization = timescope('Name', 'Time-Delay Visualization');
            end
            ...
            titles = {'Downlink Delay', 'Uplink Delay'};
            % Initialize the plots
            if numel(obj.PlotIDs) == 1
