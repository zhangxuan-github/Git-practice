...
% Copyright 2020 The MathWorks, Inc.
    ...
    methods (Access = public)
        ...
        function bufferStatusReport = getBufferStatus(obj)
            ...
            %
            %   BUFFERSTATUSREPORT is a structure, which contains the
            %   following fields:
            ...
            % Get the buffer status report structure and update the buffer
            % status field with the required grant length
            bufferStatusReport = obj.RLCBufferStatus;
            bufferStatusReport.BufferStatus = obj.RequiredGrantLength;
        end
        ...
        function sdu = receivePDU(obj, packet)
            ...
            if decodedPDU.SegmentationInfo == 0
                ...
                % reassembly
                % revised: by sygu
                if all(getModulusValue(obj, obj.RxNextHighest - obj.UMWindowSize) <= snModuloValue & snModuloValue < getModulusValue(obj, obj.RxNextReassembly))
